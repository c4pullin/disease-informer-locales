...
room-radiation = Radiation
    .description = I hope it's safe...
room-centrifuge = Centrifuge
...
-virus = virus
-no-virus-match = No disease found matching your query.
...
-allowed-interference = You allowed other people to interact with the trainer.
-forbidden-interference = You won't be disturbed by other people.
...
cmd-doctortrainer = doctortrainer
    .description = An ADC disease simulator
    .virus = { -virus }
    .virus-describe = If you want to train for a specific virus.
    .cap = cap
    .cap-describe = The max amount of diseases at a time. Defaults to 2.
    .allow-interference = allow_interference
    ...
    .title = Welcome to the doctortrainer.
    .trainer-for = { $person }'s trainer
    .virus-notchosen = You haven't chosen a virus, so you'll get a random one.
                       ...
                       *[0] { -forbidden-interference }
                       ...
                       Good luck :D
    .virus-chosen = You have chosen to cure: **{ $virus }**
                    Only **{ NUMBER($cap) }** diseases can appear at the same time.
                    { $allowed ->
                    [1] { -allowed-interference }
                    *[0] { -forbidden-interference }
...
# For all btn, try to make it as short as possible so it fits on mobile.
cmd-update-cure = cure
    .description = Update the cures (if you are an allowed editor)
    .virus = { -virus }
    .virus-describe = The virus to edit
    .symptom = symptom
    .symptom-describe = If you want to update the symptoms. Default is False.
    .emb-title = Welcome to the editor
    .emb-desc = You will be editing **{ $virus }**
    .emb-cure-title = Steps for **{ $virus }**:
    .editing = { $user } is editing **{ $virus }**
    .step = Current step: **{ NUMBER($start) }**/**{ NUMBER($end) }**
    .room = Room
...
cmd-fight = fight
    ...
    .time = Pillow fight <t:9999999999:R>
...
not-allowed-editor = You are not an allowed editor.
